...
root=Tk()
root.title("Farha's Notepad")
savebtn=Button(root,command=saveDoc,text="Save")
savebtn.grid(row=1,column=0)
savebtn.config(font=('arial',20,'bold','Italic'),bg="red",fg="black")
fontbtn=Menubutton(root,text="Font")
fontbtn.config(font=('arial',20,'bold', 'italic'),bg="red",fg="black")
...
boldbtn.config(font=('arial',20,'bold','Italic'),bg="red",fg="black")
textarea=Text(root)
